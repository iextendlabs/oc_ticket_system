...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/module/tickets')) {
				$tickets[] = array(
					'name'	   => $this->language->get('text_ticket_dashboard'),
			...
			if ($this->user->hasPermission('access', 'extension/module/tickets')) {
				$tickets[] = array(
					'name'	   => $this->language->get('text_ticket_list'),
			...
			if ($this->user->hasPermission('access', 'extension/module/tickets')) {
				$tickets[] = array(
					'name'	   => $this->language->get('text_agents'),
					'href'     => $this->url->link('extension/module/tickets/getAgentList', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
